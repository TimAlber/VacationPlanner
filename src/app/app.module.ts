...
import { VacDetailComponent } from "./vac-detail/vac-detail.component";
import { EntitelmentDialogComponent } from "./users-detail/entitelment-dialog/entitelment-dialog.component";
import { PartTimeDialogComponent } from "./core/part-time-dialog/part-time-dialog.component";
...
const appRoutes: Routes = [
  ...
  {
    path: "your-stats",
    component: YourStatsComponent,
    canActivate: [AngularFireAuthGuard]
  },
  {
    path: "vacation-detail",
    component: VacDetailComponent,
    canActivate: [AngularFireAuthGuard]
  },
  {
    path: "admin-area",
...
@NgModule({
  ...
  providers: [AngularFireAuthGuard, AlwaysAuthGuard, DatePipe], // AuthGuard
  bootstrap: [AppComponent],
  entryComponents: [EntitelmentDialogComponent, PartTimeDialogComponent]
})
